...
#define STRING_CONFIG_H_AUTHOR "(ChrisTopZ, Ender-3 Pro w/ SKR Mini E3 v2.0 & TFT 35)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "CTZ-BOT Ender-3 Pro"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Creality Ender-3 Pro
    ...
    #define DEFAULT_Kd_LIST {  47.30,  47.30 }
  #else
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79.23, 80.24, 403.80, 137.70 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -43, -8.5, -2.950 }
